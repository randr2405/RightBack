...
export default function AdminPage() {
  ...
  function handleMediaUpload(e: ChangeEvent<HTMLInputElement>) {
    ...
    // TODO: upload each `file` to Vercel Blob (or similar) here, then swap
    // the local object URL for the real hosted URL and save it to the DB.
    e.target.value = "";
  }

  function handleMediaDelete(id: string) {
    setMediaItems((items) => items.filter((item) => item.id !== id));
    // TODO: also delete from storage + DB once wired up.
  }
